...
def ejecutar_COMBINAEXCEL():
    os.system(r"\\fjcaldas\SDH-Secretaria_Distrital_de_Hacienda\EJECUTABLES_PROCESOS_OK\ENTORNO_GUI\COMBINAEXCEL.py")
   
def ejecutar_NOMBRES_GUI():
    os.system(r"\\fjcaldas\SDH-Secretaria_Distrital_de_Hacienda\EJECUTABLES_PROCESOS_OK\ENTORNO_GUI\NOMBRES_GUI.py")
    
def ejecutar_RENOMBRAR_PARA_CORREO_GUI():
    os.system(r"\\fjcaldas\SDH-Secretaria_Distrital_de_Hacienda\EJECUTABLES_PROCESOS_OK\ENTORNO_GUI\RENOMBRAR_PARA_CORREO_GUI.py")
    
def ejecutar_NUMERO_DE_ACTA():
    os.system(r"\\fjcaldas\SDH-Secretaria_Distrital_de_Hacienda\EJECUTABLES_PROCESOS_OK\ENTORNO_GUI\NUMERO_DE_ACTA.PY")

def ejecutar_F():
    os.system(r"\\fjcaldas\SDH-Secretaria_Distrital_de_Hacienda\EJECUTABLES_PROCESOS_OK\ENTORNO_GUI\F.PY")
...
apps_menu.add_command(label="RENOMBRAR PARA CORREO", command=ejecutar_RENOMBRAR_PARA_CORREO_GUI)
...
apps_menu.add_command(label="COMBINAR EXCEL", command=ejecutar_COMBINAEXCEL)
apps_menu.add_command(label="NOMBRES", command=ejecutar_NOMBRES_GUI)
apps_menu.add_command(label="NUMERO DE ACTA", command=ejecutar_NUMERO_DE_ACTA)
apps_menu.add_command(label="FILTAR BASES POR REGISTROS", command=ejecutar_F)
